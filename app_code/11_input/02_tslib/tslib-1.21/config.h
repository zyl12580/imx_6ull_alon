...
#define PACKAGE_STRING "tslib 1.21"
...
/* whether evthres should be build as part of libts or as a separate shared
   library which is dlopen()-ed at runtime */
/* #undef TSLIB_STATIC_EVTHRES_MODULE */
...
/* whether input-evdev should be build as part of libts or as a separate
   shared library which is dlopen()-ed at runtime */
/* #undef TSLIB_STATIC_INPUT_EVDEV_MODULE */
